...
{
    /// <summary>
    /// The base script that contains functions to save and load IStorageBinding classes.
    /// </summary>
    /// <typeparam name="T">A serializable class that extends the IStorageBinding interface.</typeparam>
    [System.Serializable]
    public class BindingsLocalStorage<T> where T : IStorageBinding
    {
        /// <summary>
        ...
        private class SerializeBindings
        {
            ...
            /// List of bindings.
            /// </summary>
            [SerializeField] public List<T> bindings = new List<T>();
        }
        ...
        {
            get { return this.serializedData.bindings; }
        }
